...
namespace Sales.Domain.Tests
{
    ...
    {
        [TestMethod]
        public void CalculateDiscount_WhenDiscountCriteriaMet_ThenDiscountIsApplied()
        {
            //Arrange
        ...
        [TestMethod]
        public void CalculateDiscount_WhenDiscountCriteriaDontMet_ThenDiscountIsNotApplied()
        {
            //Arrange
